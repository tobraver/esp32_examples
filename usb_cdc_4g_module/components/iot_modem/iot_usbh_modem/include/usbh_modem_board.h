...
/**
 * @brief This function is used to get the unique sim number, otherwise return ESP_FAIL if the network is not registered.
 *
 * @param buf buffer to store name
 * @param buf_size buffer size
 * @return ** esp_err_t
...
/**
 * @brief Get 4g integrated circuit card identifier
 *
 * @param buf buffer to iccid info
 * @param buf_size buffer size
 * @return ** esp_err_t
 */
